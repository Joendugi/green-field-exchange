            ...
            <main className="container mx-auto px-4 py-20">
                <section className="text-center mb-20 reveal">
                    ...
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                        Founded in 2024,  wakulima agri-connect was born from a simple observation: the gap between those who grow our food and those who eat it was getting wider. We set out to bridge that gap using modern technology.
                    </p>
                </section>
                ...
                <section className="py-24 mb-24 reveal">
                    ...
                    <div className="max-w-4xl mx-auto relative space-y-12">
                        ...
                        {[
                            { year: "2024", title: "The Seed", desc: " wakulima agri-connect founded in San Jose with a mission to digitize the local harvest." },
