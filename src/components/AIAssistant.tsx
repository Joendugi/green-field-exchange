...
const AIAssistant = () => {
  const [messages, setMessages] = useState<any[]>([
    {
      role: "assistant",
      content: "Hello! I'm your  wakulima agri-connect AI assistant. I can help you with agricultural advice, market insights, pricing guidance, and farming best practices. How can I assist you today?",
    },
  ]);
