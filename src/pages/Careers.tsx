...
const Careers = () => {
  ...
  const openings = [
    ...
    },
    {
      ...
      experience: "Mid",
      salary: "$80k - $100k",
      description: "Support farmers in maximizing their success on  wakulima agri-connect. Provide training, resolve issues, and gather feedback.",
      requirements: [
      ...
      <div className="bg-gradient-to-b from-emerald-50 to-white">
          ...
          <div className="container mx-auto px-4 py-20">
            <div className="text-center max-w-4xl mx-auto">
              <h1 className="text-5xl font-bold mb-6 animate-fade-in">
                Careers at  wakulima agri-connect
              </h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-bold text-center mb-12">Why Work at  wakulima agri-connect?</h2>
